# Image Credits - Listening/Speaking, Intermediate Band, Module 2 (Narrating), Set 1

Every image embedded in this Set's lesson packets, one table per lesson, per
`shared/Program_Conventions.md` §D/§I. All files come from Wikimedia Commons under a license this program
accepts (Public domain, CC0, CC BY, or CC BY-SA). **The packets themselves print no credit**
(`shared/Student_Packet_Style_Guide.md` §F); this register is where credit lives.

Created 2026-09-10 with Lesson 1, this Set's first images.

## Lesson 1: The New Kid and the Voice in the Hallway (`Lesson_1_NewKid/`)
...
| Asset file | Where used | Commons file title | Author | License | Source URL |
| --- | --- | --- | --- | --- | --- |
| `Lesson2_FireRescue_Img_ChoiceFireEngine.jpg` | Unit 2A, Task A item 1 and Task B item 1 picture choices | CH Fire engine Berne.jpg | Daniel Schwen | CC BY-SA 4.0 | https://commons.wikimedia.org/wiki/File:CH_Fire_engine_Berne.jpg |
| `Lesson2_FireRescue_Img_ChoiceBunkBeds.jpg` | Unit 2A, Task A item 1 and Task B item 1 picture choices | BC - Cabin 7 Bedroom (5857339143).jpg | Virginia State Parks staff | CC BY 2.0 | https://commons.wikimedia.org/wiki/File:BC_-_Cabin_7_Bedroom_(5857339143).jpg |
| `Lesson2_FireRescue_Img_ChoiceStore.jpg` | Unit 2A, Task A item 1 and Task B item 1 picture choices | Extra Coop supermarket, Bergen Storsenter, Norway 2017-11-01 cashier checkout a.jpg | Wolfmann | CC BY-SA 4.0 | https://commons.wikimedia.org/wiki/File:Extra_Coop_supermarket,_Bergen_Storsenter,_Norway_2017-11-01_cashier_checkout_a.jpg |

All three were fetched 2026-09-10 at 960px and saved unchanged in the lesson folder; the packet embeds a
downscaled base64 copy of each. This lesson's opening hook is a printed line from the clip, not a photo, so
it needs no image.
