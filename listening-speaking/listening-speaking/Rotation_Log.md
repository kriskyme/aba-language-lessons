...
- [`Rotation_Log_Advanced.md`](Rotation_Log_Advanced.md) - Module 1: Describing, Set 1 (2 of 4 lessons generated), Set 2 (planned only)
...
Advanced Set 1 is not yet complete (see `Rotation_Log_Advanced.md`).
