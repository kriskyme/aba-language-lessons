# Listening/Speaking Rotation Log — Advanced Band
...
(see `Rotation_Log.md`'s day-count correction note). **Restructured 2026-09-04:** both lessons rewritten to the
current Day 1 (Unit A)/Day 2 (Unit B) architecture, using the Lesson Generation Prompt's fifth-addendum mapping
table - no task, quote, vocabulary item, or differentiated activity was cut, only reorganized, matching
Intermediate Set 1's own restructure precedent. Both lessons' student packets were also rebuilt from scratch to
...
secondary (Level 7 only, excerpt): Boise Art Scene's "Wil Kirkman, Owner of Rocket Neon - Full Text Artist Sit
...
Hosokawa/National Key Deer Refuge, Chris Bergh/The Nature Conservancy, Connie Ritchie, Jan Svejkovsky/Save Our
