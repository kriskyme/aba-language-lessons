...
modalities actually differ. See `Generate_Lesson_Prompt_v6.10.md`, Section 0.1, for the specific reason: a Reading
...
| --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| `Generate_Lesson_Prompt_v6.10.md` | Generates one **2-day lesson**: for Beginner, one of a Set's 4 fixed positions; for Intermediate/Advanced/Proficient, one of a Module Pair's 8 positions ("THE MODULE PAIR" section), each run producing one lesson at the named position against the approved plan. Run with `shared/Program_Conventions.md` and `shared/Generation_Quality_Standards.md` pasted alongside; states only what is true of a writing lesson (the three-regime model and Scenario/Mentor Ladder in 0.1, per-Level output ceilings and required features in 0.2, the Grammar and Essay Focus banks and row-selection rules in 0.4/0.4c, self-revision evidence in 0.4a, content-volume minimums in 0.4b, checklists and Peer Editing timing in 0.6, the Module-to-form mapping in 0.9, the Module Pair arc and the per-lesson flow) and points to the shared files for everything modality-neutral. Section 0.3's self-check is the shared Quality Standards §F list plus 16 Writing-only items. Section 0 now uses `Lesson N, Day M` numbering throughout. | Current (v6.10); all four Intermediate Set 1 lessons regenerated against v6 2026-09-08 and Lessons 2-4 revised under v6.2's practice/draft-object split and v6.3's self-contained/concrete-prompt rules the same day (1.1.1.6, 1.1.2.8, 1.1.3.12, 1.1.4.13; see "First run" below); the Advanced Set's four lessons were generated under v4/v4.1 and retrofitted under v5 |
...
**Step 2 - Generate the lessons, one at a time.** Run `Generate_Lesson_Prompt_v6.10.md` (pasted with
...
**Optional - Student print handout.** Run `Generate_Student_Packet_Prompt_v3.13.md` against any completed lesson to
...
`Generate_Student_Packet_Prompt_v3.13.md` alongside its Markdown's v6 regeneration, 1.1.3.1). The slug names
...
Pair addendum and `Generate_Lesson_Prompt_v6.10.md`'s "THE MODULE PAIR"), two consecutive Modules pair into one
...
Intermediate Module 1 Set 1 Lesson 1 (`Lesson_1_MyPhoneCase/`) was regenerated against `Generate_Lesson_Prompt_v6.10.md`
plus the two shared files, and its packet against `Generate_Student_Packet_Prompt_v3.13.md` plus the Style Guide;
...
completed once per lesson at most (Quality Standards v1.5 §D10; `1.1.1.6`, `1.1.2.8`, `1.1.3.12`, `1.1.4.13`).
...
- **Grammar/Essay Focus Bank "Alternate" rows are not yet authored.** `Generate_Lesson_Prompt_v6.10.md`'s Section
