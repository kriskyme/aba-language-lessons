...
- [`Rotation_Log_Advanced.md`](Rotation_Log_Advanced.md) - Module 1, Set 1 ("Two Places to Study", Lessons 1-4) and Module 2, Set 1 ("My Last Meal, then A Meal That Went Wrong", a standalone Set, Advanced 1-4, planned and generated 2026-09-14). Modules 1-2 were de-paired 2026-09-14 (Conventions §C's Standing exception), so Module 1's Lesson 4 hand-off has no receiver.
- [`Rotation_Log_Proficient.md`](Rotation_Log_Proficient.md) - Module 1, Set 1 ("The Bag I Carry", Lessons 1-4 at `1.1.x.0`) and Module 2, Set 1 (the same bag, Lessons 1-4 at `2.1.x.0`): the complete Module Pair 1-2, planned by `lessons/proficient/ModulePair_1-2/ModulePair_1-2_Proficient_Lesson_Plan.md`. Created 2026-09-10 on this Band's first Set
- [`Rotation_Log_Beginner.md`](Rotation_Log_Beginner.md) - Module 1, Set 1 ("My Notebook" then "My Hat", Lessons 1-4 at `1.1.x.0`) and Module 2, Set 1 ("My Morning" then "My Trip", Lessons 1-4 at `2.1.x.0`), each planned by its own `Module<N>_Beginner_Lesson_Plan.md`. Beginner is exempt from Module Pairs, so its rows carry no Pair position, each Module is a self-contained Set, and every Lesson 4 is a finale

Maintained by `Generate_Module_Lesson_Plan_Prompt_v4.6.md` (Section 0) and `Generate_Lesson_Prompt_v6.18.md` (Section
...
`Generate_Lesson_Prompt_v6.18.md` Section 0.9's note on grammar clustering across nearby Modules, not just literal
...
both choices are decided together in one `Generate_Module_Lesson_Plan_Prompt_v4.6.md` pass. See
`Generate_Lesson_Prompt_v6.18.md` Section 0.9 and `shared/Program_Conventions.md` §C's Module Pair addendum.
