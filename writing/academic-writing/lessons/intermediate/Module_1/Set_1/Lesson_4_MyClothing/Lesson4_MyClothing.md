...
**Module:** 1, Describing | **Band:** Intermediate | **Task Levels:** 2, 3, 4, 5 | **Version:** 1.1.4.17
...
hand-off-not-publish role are taken as given from the approved `Module1_Intermediate_Lesson_Plan.md` and the
Module Pair table; what changed is the content built on them - see `Changelog.md`. Module 2's Set, which
completes and publishes the piece handed off here, has not yet been planned or generated._
...
- **Focus B (Lesson 2):** simple versus compound sentences joined by and / but / so, with a comma before the
  connector; the confusable pair it's / its.
- **Level 5 extension (Lessons 1-2):** hedges (a bit, a little, seems, at least, probably) and one concession
  subordinator (although, even though) as an upgrade from a plain "but" sentence.
- **Frame content (Lesson 1):** the frames "It is ___." and "It is ___ and ___."; two slots carry two different
  observations; the -s ending on a full-sentence verb (It looks new.).

**Draft Word Bank (reprinted from Lesson 2 Day 2; posted on the board and printed in the packet).** Levels 2-3
draw their describing words from this list; Levels 4-5 may use it when a word is not coming to mind.
...
**Output targets for the completed draft (Section 0.2), counted before hand-off:** Level 2, one word in the
one-slot frame; Level 3, two words in the two-slot frame; Level 4, 3-6 sentences and 40-90 words with one
comparison and one stated reason; Level 5, 6-9 sentences and 90-150 words with details in a logical order and one
detail that implies a feeling without stating it.
...
- **Level 2:** "It is ___." about your partner's pen, with a word spelled from sound (long, short, blue, thin).
- **Level 3:** "It is ___ and ___." about your partner's pen, two different observations.
- **Level 4:** one sentence comparing your pen to your partner's, with a reason word (because, since, as, or
  given that) and a real reason ("My pen is thinner than Ana's, because I like to keep it in my pocket").
- **Level 5:** the same comparison sentence, then a second sentence with one concrete detail about your own pen
